...
public class ConstantTableController {
	...
	@RequestMapping(value = "/const-status-table", method = RequestMethod.GET)
	public List<Map<String, Object>> getConstName() {

		String selectConstName = "SELECT * FROM const_status_table";
	...
	@RequestMapping(value = "/const-status-table", method = RequestMethod.POST)
	public int createConstName(@RequestBody Map<String, Object> map) throws Exception {
		...
		try {
			...
			String insertConstName = "INSERT INTO const_status_table (status_id, status_name) VALUES (:status_id, :status_name)";
	...
	@Transactional(rollbackFor = Exception.class)
	@RequestMapping(value = "/const-status-table/{status_id}", method = RequestMethod.PUT)
	public int updateConstName(@PathVariable("status_id") int statusId, @RequestBody Map<String, Object> map)
		...
		String updateConstName = "UPDATE const_status_table SET status_name = :status_name WHERE status_id = :status_id";
	...
	@Transactional(rollbackFor = Exception.class)
	@RequestMapping(value = "/const-status-table/{status_id}", method = RequestMethod.DELETE)
	public int deleteConstName(@PathVariable("status_id") int statusId) throws Exception {

		// Check Exists status_id of Data
		checkExistsConstNameStatusId(statusId);

		String deleteConstName = "DELETE FROM const_status_table WHERE status_id = " + statusId;
	...
	private void checkExistsConstNameStatusId(int StatusId) throws Exception {
		...
		String selectConstName = "SELECT * FROM const_status_table WHERE status_id = " + StatusId;
		List<Map<String, Object>> listConstName = repo.query(selectConstName);
